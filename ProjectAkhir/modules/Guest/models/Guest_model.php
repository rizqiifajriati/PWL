...
//fungsi tampil data
    ...
    {
        $this->db->select("a.id,a.person,a.status,a.id_card,a.tgl,a.nama,a.instansi,a.telp,a.keperluan,b.st_antri,b.nama as nama_pegawai,b.id_peg,");
