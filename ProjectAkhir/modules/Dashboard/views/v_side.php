...
<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./"><img src="<?php echo base_url('images/20210707_065602.png')?>" alt="Logo"></a>
            <a class="navbar-brand hidden" href="./"><img src="<?php echo base_url('images/20210707_064427.png')?>" alt="Logo"></a>
        </div>
            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="<?php echo base_url('images/adminn.jpg')?>" width="100" height="75" alt="User Avatar">
                    </a>
